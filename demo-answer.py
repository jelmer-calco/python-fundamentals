...
if person_age >= 18:
    print(person_name, "is an adult")
else:
    print(person_name, "is underage")
...
foods = ["pizza", "noodles", "salad"]

print_foods(foods)


# ============================================================
# EXTRA MINI CHALLENGE - COMBINE FUNCTIONS, LISTS AND IF/ELSE
# ============================================================
...
# ------------------------------------------------------------
# Extra Demo - Check grades inside a function
# ------------------------------------------------------------
...
student_grades = [5, 6, 8, 3, 9]

check_grades(student_grades)
...
# Create a function called check_ages.
# The function gets a list of ages.
# For each age, print whether the person is an adult or underage.


# ------------------------------------------------------------
# Extra Assignment - Solution
# ------------------------------------------------------------
...
student_ages = [14, 18, 22, 16, 30]

check_ages(student_ages)
...
# - use parameters
# - use return
# - combine functions with loops and if/else